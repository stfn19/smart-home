...
public class HomeFragment extends Fragment implements OnBackPressed {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBedroom.setOnClickListener(new View.OnClickListener() {
                ...
                Navigation.findNavController(mView).navigate(R.id.roomFragment2, bundle1);
        ...
        mLiving_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(mView).navigate(R.id.roomFragment2,bundle2);
        ...
        mBathroom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(mView).navigate(R.id.roomFragment2,bundle3);
        ...
        mKitchen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(mView).navigate(R.id.roomFragment2,bundle4);
        ...
        mStore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(mView).navigate(R.id.roomFragment2,bundle5);
        ...
        mStudy_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(mView).navigate(R.id.roomFragment2,bundle6);
